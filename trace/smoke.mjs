...
assert(files.indexOf("variety-v8-finish.js")<files.indexOf("variety-v8-boot.js"),"release gate must load before v8 boot");
...
console.log(`TRACE SMOKE OK · ${files.length} boot scripts · ${tagCount} tags · ${new Set(ids).size} unique DOM ids`);
